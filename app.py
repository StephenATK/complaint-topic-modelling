...
THEMES = {
    "Day": {
        ...
        "card_border": "#e2e6ec",
        "text": "#1b3865",
        "text_secondary": "#5e5e5f",
        "header_grad": "linear-gradient(135deg, #1b3865 0%, #2f5b93 55%, #45c8f3 130%)",
        "brand_icon_grad": "linear-gradient(135deg, #1b3865 0%, #45c8f3 100%)",
        "nav_selected_bg": "#1b3865",
        "nav_selected_text": "#FFFFFF",
        "nav_hover_bg": "#e2edf8",
        "wc_bg": "#FFFFFF",
        "grid_color": "#d8dee6",
        "topic_colors": [
            "#1b3865", "#f47a21", "#45c8f3", "#5c7ba3", "#f4a35c",
            "#8fdcf7", "#0f2540", "#c25e14", "#2f95b8", "#a4b8cd", "#5e5e5f",
        ],
    },
    "Night": {
        "app_bg": "#0d1826",
